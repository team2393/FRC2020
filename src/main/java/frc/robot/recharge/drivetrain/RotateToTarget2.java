...
public class RotateToTarget2 extends CommandBase 
{
  ...
  private final BiConsumer<Double, Double> driver;
  ...
  public void execute()
  {
    ...
    driver.accept(MathUtil.clamp(speed, -max, max), MathUtil.clamp(rotation, -max, max));
